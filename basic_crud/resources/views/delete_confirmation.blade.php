...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           <h1>Delete Address Confirmation</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            &nbsp;
                            <button type="button" onclick="location.href='/addressbook/exec_delete/{{ $thename }}/';">Delete</button>
                        </div>
        ...
        <script>
            ...
            function delete_addressbook(NAMA)
            {
                $.get("/addressbook/exec_delete/" + NAMA + "/");
            }
